...
## Profile plots
We will generate profile plots to evaluate enrichment in our samples and to decipher the nature of PRDM16 binding in cortical neurons. The profile plot allows us to **evaluate read density over sets of genomic regions**. Typically, these regions are genes (start and end coordinates), but any other regions defined in the BED file will work. 
